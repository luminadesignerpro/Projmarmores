...
async function gerarPdfContrato(dados, fetchLogo) {
  ...
  paragraph('A CONTRATADA obriga-se a fornecer e instalar ao CONTRATANTE os seguintes serviços de marmoraria, granitos e importados:', pSize, fontRegular, DARK, MARGIN, CONTENT_W, pLineH);
  y -= 4;
  ...
  centerText('PROJMARMORES', line1X, colW, 10, fontBold, DARK);
